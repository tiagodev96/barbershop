      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-zinc-300 max-w-3xl mx-auto leading-relaxed">
            Há mais de 15 anos transformando o visual masculino com excelência.
            Nossa missão é proporcionar uma experiência única, combinando
            tradição, qualidade e inovação em cada atendimento.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="bg-zinc-800 border-zinc-700 hover:bg-zinc-750 transition-colors"
            >
